<header {{ $attributes->merge(['class' => 'h-16 shrink-0 bg-white dark:bg-zinc-900 border-b border-zinc-200 dark:border-zinc-800 flex items-center px-3 justify-between shadow-sm']) }}>
    ...
    <div class="hidden md:flex items-center gap-4 ml-4">
        <div class="text-right">
            <p class="text-[10px] font-black text-zinc-400 uppercase tracking-widest">{{ auth()->user()->role }}</p>
